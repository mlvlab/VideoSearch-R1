...
export EXP_NAME="${EXP_NAME:-activitynet_v1_stable_noaux}"
export WANDB_NAME="${WANDB_NAME:-activitynet_v1_stable_noaux}"
...
export MODEL_PATH="${MODEL_PATH:-activitynet-stage1}"
set_grpo_dataset_defaults "activitynet"
