...
OUTPUT_JSONL="${OUTPUT_JSONL:-${DATASET_ROOT}/grpo_data/train.minimal_top1.jsonl}"
OUTPUT_STATS_JSON="${OUTPUT_STATS_JSON:-${DATASET_ROOT}/grpo_data/stats.minimal_top1.json}"
DATA_CONFIG_PATH="${DATA_CONFIG_PATH:-${VIDEOSEARCH_OUTPUT_ROOT}/configs/data_config.activitynet_grpo.yaml}"
DATASET_NAME="${DATASET_NAME:-ActivityNet}"
DATASET_KEY="${DATASET_KEY:-Verified-Search-Minimal-Top1-ActivityNet}"
ANNO_PATH_IN_CONFIG="${ANNO_PATH_IN_CONFIG:-${OUTPUT_JSONL}}"
...
echo "[activitynet][06_build_verified_search_minimal_top1] done: ${OUTPUT_JSONL}"
