...
ANNO_ROOT="${ANNO_ROOT:-${VIDEOSEARCH_DATA_ROOT}/fine-grained-anno/activitynet-fig}"
TRAIN_JSONL="${TRAIN_JSONL:-${ANNO_ROOT}/activitynet_fig_train.jsonl}"
VAL_JSONL="${VAL_JSONL:-${ANNO_ROOT}/activitynet_fig_val_1.jsonl}"
TEST_JSONL="${TEST_JSONL:-${ANNO_ROOT}/activitynet_fig_val_2.jsonl}"
VIDEO_BASE="${VIDEO_BASE:-${VIDEOSEARCH_DATA_ROOT}/raw_videos/activitynet/videos}"
...
# Val split (val_1) -> val/val_queries.jsonl
PYTHONPATH=. "${PYTHON_BIN}" -m annotation_process.prepare_activitynet_segments \
...
# Test split (val_2) -> test/test_queries.jsonl
PYTHONPATH=. "${PYTHON_BIN}" -m annotation_process.prepare_activitynet_segments \
