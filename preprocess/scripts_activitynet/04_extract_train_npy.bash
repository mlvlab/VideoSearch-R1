...
DATASET_JSONL="${DATASET_JSONL:-${DATASET_ROOT}/train/train_queries.jsonl}"
VIDEO_ID_KEY="${VIDEO_ID_KEY:-pos_doc_id}"
VIDEO_SOURCE_ROOT="${VIDEO_SOURCE_ROOT:-${VIDEOSEARCH_DATA_ROOT}/raw_videos/activitynet/videos}"
OUTPUT_DIR="${OUTPUT_DIR:-${DATASET_ROOT}/train/video_npy_with_meta}"
