...
OUTPUT_JSONL="${OUTPUT_JSONL:-${VIDEOSEARCH_ROOT}/data/verified_search/didemo.train.minimal_top1_system_prompt.jsonl}"
OUTPUT_STATS_JSON="${OUTPUT_STATS_JSON:-${VIDEOSEARCH_ROOT}/data/verified_search/stats.didemo.minimal_top1.json}"
DATA_CONFIG_PATH="${DATA_CONFIG_PATH:-${VIDEOSEARCH_ROOT}/data/data_config.yaml}"
DATASET_NAME="${DATASET_NAME:-DiDeMo}"
DATASET_KEY="${DATASET_KEY:-Verified-Search-Minimal-Top1-DiDeMo}"
ANNO_PATH_IN_CONFIG="${ANNO_PATH_IN_CONFIG:-data/verified_search/didemo.train.minimal_top1_system_prompt.jsonl}"
...
echo "[didemo][06_build_verified_search_minimal_top1] done: ${OUTPUT_JSONL}"
